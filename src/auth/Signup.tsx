      ...
      <div className="w-[45%] mx-auto">
        <div className="max-w-md mx-auto mt-10 p-6 rounded-lg border border-[#4d4d4d]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-[#4d4d4d] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <a href="/login" className="ml-1 font-medium hover:underline">
              Login
            </a>
          </div>
        </div>
