...
const NAV_ITEMS = [
  { label: "All items", icon: LayoutList, count: 5, id: "all" },
  { label: "Favorites", icon: Star, count: 2, id: "favorites" },
]

const CATEGORIES = [
  { label: "Social", icon: Globe, count: 2, id: "social" },
  { label: "Work", icon: Briefcase, count: 2, id: "work" },
  { label: "Finance", icon: CreditCard, count: 1, id: "finance" },
]
...
export default function Sidebar({ activeId = "all", onSelect, onAddNew }) {
